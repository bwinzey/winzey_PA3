...
public class CAI5 {
	public static void main(String[] args) {
		...
		System.out.println("Enter a problem type bewteen 1-4");
		String problemType=readResponse();
		while(!problemType.equals("1")&&!problemType.equals("2")&&!problemType.equals("3")&&!problemType.equals("4")) {
			System.out.println("Enter a problem type bewteen 1-4");
			problemType=readResponse();
		}
		
		int sum=0;
		for(int i=0;i<10;i++) sum=sum+quiz(difficulty, problemType);
	...
	public static int quiz(String diff,String type) {
		...
		switch(type) {
		case "1":
			question="How much is "+n1+" plus "+n2+"?";
			realAnswer=""+(n1+n2);
			break;
		case "2":
			question="How much is "+n1+" times "+n2+"?";
			realAnswer=""+n1*n2;
			break;
		case "3":
			question="How much is "+n1+" minus "+n2+"?";
			realAnswer=""+(n1-n2);
			break;
		case "4":
			question="How much is "+n1+" divided by "+n2+"?";
			realAnswer=""+((1.0*n1)/n2);
